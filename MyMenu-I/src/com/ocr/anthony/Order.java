...
import static com.ocr.anthony.Interaction.askMenu;
...
public class Order {
    ...
    public void displayAvailableMenu() {
        ...
        System.out.println("1 _ poulet");
        System.out.println("2 _ boeuf");
        System.out.println("3 _ vévétarien");
    ...
    public void runMenu() {
        ...
        int nbMenu = Interaction.askMenu();
        do {
            nbMenu = sc.nextInt();
            this.displaySelectedMenu(nbMenu);
            switch (nbMenu) {
                case 1:
                    Interaction.askSide(true);
                    Interaction.askDrink();
                    break;
                case 2:
                    Interaction.askSide(true);
                    break;
                case 3:
                    Interaction.askSide(false);
                    Interaction.askDrink();
                    break;
            }
